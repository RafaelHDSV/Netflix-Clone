...
// formatação do valor do LocalStorage para o valor aceito pela API
let type = ""
if (localStorage.getItem("selectOption") === "Todos") {
    type = ""
}
if (localStorage.getItem("selectOption") === "Filmes") {
    type = "movie"
}
if (localStorage.getItem("selectOption") === "Séries") {
    type = "tv"
}
